...
C:\\Users\\admin\\Downloads and pushes data/tickets.json to GitHub.
The v2 dashboard (index.html) is a static file — it fetches tickets.json
dynamically and must not be overwritten by this script.
